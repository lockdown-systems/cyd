...
const formattedAttachedStoryText = computed(() => {
  const text = props.story.attachedStory?.text
    ? props.story.attachedStory.text
    : "";
  return newslinesToBrs(text);
});
</script>
...
<template>
  <div class="post p-3 mb-3 border rounded">
    <div class="d-flex justify-content-between">
      ...
      <small v-if="story.createdAt">{{
        formattedDatetime(story.createdAt)
      }}</small>
    ...
    <div class="mt-2">
      ...
      <div v-if="story.attachedStory" class="attached-story">
        ...
        <div class="attached-story-item p-1 border rounded">
          <p
            v-if="story.attachedStory.text"
            :html="formattedAttachedStoryText"
          ></p>
          <div v-if="story.attachedStory.media" class="media-container mt-2">
            <div
              v-for="media in story.attachedStory.media"
              :key="media.mediaID"
              class="mb-2"
            >
