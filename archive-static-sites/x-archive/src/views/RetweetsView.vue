...
<template>
    <div class="tweets-container">
        <div class="filter-container">
            ...
            <p class="text-center text-muted small">Showing {{ filteredRetweets.length.toLocaleString() }} retweets</p>
        </div>

        <div class="tweets-list">
            <TweetComponent v-for="tweet in filteredRetweets" :key="tweet.tweetID" :tweet="tweet" />
        </div>
    </div>
</template>
