...
<template>
    <div class="tweets-container">
        <div class="filter-container">
            <p><input type="text" v-model="filterText" class="form-control" :placeholder="filterTextPlaceholder"></p>
            <p class="text-center text-muted small">Showing {{ filteredTweets.length.toLocaleString() }} {{
                tweetTypePlural }}</p>
        </div>
