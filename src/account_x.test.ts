            ...
            this.responseData = [
                {
                    ...
                    requestBody: '',
                    responseHeaders: {},
                    responseBody: fs.readFileSync(path.join(__dirname, '..', 'testdata', 'x', 'XUserTweetsAndReplies1.json'), 'utf8'),
                    processed: false
                },
                {
                    host: 'x.com',
                    ...
                    requestBody: '',
                    responseHeaders: {},
                    responseBody: fs.readFileSync(path.join(__dirname, '..', 'testdata', 'x', 'XUserTweetsAndReplies2.json'), 'utf8'),
                    processed: false
                },
                {
                    host: 'x.com',
                    ...
                    requestBody: '',
                    responseHeaders: {},
                    responseBody: fs.readFileSync(path.join(__dirname, '..', 'testdata', 'x', 'XUserTweetsAndReplies3.json'), 'utf8'),
                    processed: false
                },
                {
                    host: 'x.com',
            ...
            this.responseData = [
                {
                    ...
                    requestBody: '',
                    responseHeaders: {},
                    responseBody: fs.readFileSync(path.join(__dirname, '..', 'testdata', 'x', 'XBookmarks.json'), 'utf8'),
                    processed: false
                }
            ];
        }
...
test("types.isXAPIError() should recognize errors", async () => {
    const body = fs.readFileSync(path.join(__dirname, '..', 'testdata', 'x', 'XUserTweetsAndRepliesError.json'), 'utf8');
    const data = JSON.parse(body);
...
test("types.isXAPIData() should recognize data", async () => {
    const body = fs.readFileSync(path.join(__dirname, '..', 'testdata', 'x', 'XUserTweetsAndReplies1.json'), 'utf8');
    const data = JSON.parse(body);
