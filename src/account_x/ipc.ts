...
const getXAccountController = (accountID: number): XAccountController => {
  if (!controllers[accountID]) {
    ...
    controllers[accountID] = new XAccountController(
      accountID,
...
export const defineIPCX = () => {
  ...
  ipcMain.handle(
    "X:createJobs",
    async (_, accountID: number, jobTypes: string[]): Promise<XJob[]> => {
      try {
        const controller = getXAccountController(accountID);
  ...
  ipcMain.handle(
    "X:getLastFinishedJob",
    async (_, accountID: number, jobType: string): Promise<XJob | null> => {
      try {
        const controller = getXAccountController(accountID);
  ...
  ipcMain.handle(
    "X:archiveTweetsStart",
    async (_, accountID: number): Promise<XArchiveStartResponse> => {
      try {
        const controller = getXAccountController(accountID);
  ...
  ipcMain.handle(
    "X:archiveTweetsOutputPath",
    async (_, accountID: number): Promise<string> => {
      try {
        const controller = getXAccountController(accountID);
  ...
  ipcMain.handle(
    "X:archiveTweet",
    async (_, accountID: number, tweetID: string): Promise<void> => {
      try {
        const controller = getXAccountController(accountID);
  ...
  ipcMain.handle(
    "X:isRateLimited",
    async (_, accountID: number): Promise<XRateLimitInfo> => {
      try {
        const controller = getXAccountController(accountID);
  ...
  ipcMain.handle(
    "X:getProgressInfo",
    async (_, accountID: number): Promise<XProgressInfo> => {
      try {
        const controller = getXAccountController(accountID);
  ...
  ipcMain.handle(
    "X:getDatabaseStats",
    async (_, accountID: number): Promise<XDatabaseStats> => {
      try {
        const controller = getXAccountController(accountID);
  ...
  ipcMain.handle(
    "X:getDeleteReviewStats",
    async (_, accountID: number): Promise<XDeleteReviewStats> => {
      try {
        const controller = getXAccountController(accountID);
  ...
  ipcMain.handle(
    "X:saveProfileImage",
    async (_, accountID: number, url: string): Promise<void> => {
      try {
        const controller = getXAccountController(accountID);
  ...
  ipcMain.handle(
    "X:getLatestResponseData",
    async (_, accountID: number): Promise<ResponseData | null> => {
      try {
        const controller = getXAccountController(accountID);
  ...
  ipcMain.handle(
    "X:deleteTweetsStart",
    async (_, accountID: number): Promise<XDeleteTweetsStartResponse> => {
      try {
        const controller = getXAccountController(accountID);
  ...
  ipcMain.handle(
    ...
    async (_, accountID: number, total: boolean): Promise<number> => {
      try {
        const controller = getXAccountController(accountID);
  ...
  ipcMain.handle(
    ...
    async (_, accountID: number, archivePath: string): Promise<void> => {
      try {
        const controller = getXAccountController(accountID);
  ...
  ipcMain.handle(
    "X:blueskyGetProfile",
    async (_, accountID: number): Promise<BlueskyMigrationProfile | null> => {
      try {
        const controller = getXAccountController(accountID);
  ...
  ipcMain.handle(
    "X:blueskyGetTweetCounts",
    async (_, accountID: number): Promise<XMigrateTweetCounts> => {
      try {
        const controller = getXAccountController(accountID);
