...
export function isXArchiveTweetContainer(
  item: XArchiveTweet | XArchiveTweetContainer,
): item is XArchiveTweetContainer {
...
export function isXArchiveLikeContainer(
  item: XArchiveLike | XArchiveLikeContainer,
): item is XArchiveLikeContainer {
