      ...
      <div class="mb-4">
        ...
        <ul class="x-archive-steps">
          ...
          <li>
            ...
            <small class="text-muted"
              >You'll probably need to type your X password. You might also need
              to get a verification code sent to your email, or do other things
              to verify your identity.</small
            >
          </li>
          <li>
