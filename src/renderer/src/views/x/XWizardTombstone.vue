...
<template>
  <div class="wizard-content container mb-4 mt-3 mx-auto">
    <div class="mb-4">
      ...
      <p class="text-muted">It's time to move on from X. How can I help you?</p>
      ...
      <form @submit.prevent>
        ...
        <div class="indent">
          ...
          <div class="mb-3">
            ...
            <div class="indent">
              <small class="form-text text-muted">
                Add "(I escaped X using https://cyd.social)" to the end of your
                bio. This uses {{ tombstoneUpdateBioCreditCydText.length }}
      ...
      <div class="buttons mb-4">
        ...
        >
          ...
          <template v-else-if="updateBanner"> Update My Banner </template>
          <template v-else-if="updateBio"> Update My Bio </template>
          <template v-else-if="lockAccount"> Lock My Account </template>
          <template v-else> Select a Checkbox Above to Continue </template>
        </button>
