  ...
  >
    ...
    <div v-if="showNoDataWarning && !lastImportArchive && !lastBuildDatabase">
      <div class="d-flex align-items-center">
        ...
        <div>
          You'll need to import your local database of tweets, or build it from
          scratch, before you can delete your tweets or likes, or migrate your
          tweets to Bluesky.
        </div>
      </div>
    </div>
    <div v-if="showButton" class="text-center">
      <button
        v-if="lastImportArchive || lastBuildDatabase"
        type="submit"
