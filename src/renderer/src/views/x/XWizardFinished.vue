    ...
    <div class="wizard-content">
        <div class="wizard-scroll-content">
            <div class="finished">
                <div v-if="jobsType == 'save'" class="container mt-3">
                    <div class="finished">
                        ...
                        <ul>
                            ...
                            <li
                                v-if="model.account.xAccount?.archiveTweets || (model.progress.retweetsIndexed ?? 0) > 0">
                                <i class="fa-solid fa-floppy-disk archive-bullet" />
                            ...
                            <li
                                v-if="model.account.xAccount?.archiveBookmarks || (model.progress.bookmarksIndexed ?? 0) > 0">
                                <i class="fa-solid fa-floppy-disk archive-bullet" />
                            ...
                            <li v-if="(model.progress.unknownIndexed ?? 0) > 0">
                                ...
                                <span class="ms-3 small text-muted">
                                    (<a href="#"
                                        @click="openURL('https://docs.cyd.social/docs/x/tips/other-tweets');">what's
                                        this?</a>)
                                </span>
                            </li>
                            <li
                ...
                <div v-if="jobsType == 'delete'" class="container mt-3">
                    <div class="finished">
                        ...
                        <ul>
                            ...
                            <li
                                v-if="model.account.xAccount?.deleteRetweets || (model.progress.retweetsDeleted ?? 0) > 0">
                                <i class="fa-solid fa-fire delete-bullet" />
                            ...
                            <li
                                v-if="model.account.xAccount?.deleteBookmarks || (model.progress.bookmarksDeleted ?? 0) > 0">
                                <i class="fa-solid fa-fire delete-bullet" />
                            ...
                            <li v-if="model.account.xAccount?.unfollowEveryone">
                                <i class="fa-solid fa-fire delete-bullet" />
                                Unfollowed <strong>{{ model.progress.accountsUnfollowed.toLocaleString() }}</strong>
                                accounts
                            </li>
                        </ul>
                    </div>
                ...
                <div v-if="jobsType == 'migrateBluesky'" class="container mt-3">
                    <div class="finished">
                        ...
                        <div v-if="model.progress.migrateSkippedTweetsCount > 0" class="alert alert-warning mt-4">
                            ...
                            <ul>
                                <li v-for="(error, tweetID) in model.progress.migrateSkippedTweetsErrors"
                                    :key="tweetID">
                ...
                <div v-if="jobsType == 'migrateBlueskyDelete'" class="container mt-3">
                    <div class="finished">
                        ...
                        <ul>
                            <li>
                                <i class="fa-brands fa-bluesky bluesky-bullet" />
                                <strong>{{ model.progress.migrateDeletePostsCount.toLocaleString() }}</strong> posts
                                that
                                were
                                migrated to Bluesky
                            </li>
                ...
                <div v-if="!hideErrors && model.progress.errorsOccured > 0" class="alert alert-danger mt-4"
                    role="alert">
                    <p>
                        <strong>Uh oh, Cyd encountered {{ model.progress.errorsOccured.toLocaleString() }}
                            errors.</strong>
