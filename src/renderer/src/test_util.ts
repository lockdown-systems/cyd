...
export function mockElectronAPI() {
  const mockElectron = {
    ...
    Bluesky: {
      ...
      getCategorySettings: vi.fn().mockResolvedValue({
        posts: false,
        reposts: false,
        likes: false,
        bookmarks: false,
      }),
      setCategoryEnabled: vi.fn().mockResolvedValue(undefined),
      storagePreflight: vi.fn().mockResolvedValue({
        categories: [{ category: "posts", recordCount: 2 }],
        certainBytes: 1024,
        estimatedBytes: 2048,
      ...
      getCollectionProgress: vi.fn().mockResolvedValue(null),
      ...
      getSavedDataSummary: vi.fn().mockResolvedValue({
        categories: [],
        complete: true,
      }),
      getMediaPath: vi.fn().mockResolvedValue(null),
    },
