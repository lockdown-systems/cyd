export enum AutomationErrorType {
    ...
    x_runJob_deleteTweets_FailedToArchive = "x_runJob_deleteTweets_FailedToArchive",
...
export const AutomationErrorTypeToMessage = {
    ...
    [AutomationErrorType.x_runJob_deleteTweets_FailedToArchive]: "Failed to archive tweet while deleting tweets",
