...
export const saveArchive = (
  ...
  try {
    ...
    streamWriter.write("{\n");
    streamWriter.write(
      `  "appVersion": ${JSON.stringify(facebookArchive.appVersion)},\n`,
    );
    streamWriter.write(
      `  "username": ${JSON.stringify(facebookArchive.username)},\n`,
    );
    streamWriter.write(
      `  "createdAt": ${JSON.stringify(facebookArchive.createdAt)},\n`,
    );
